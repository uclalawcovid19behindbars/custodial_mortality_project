...
Some processing of the files takes place, including the selection of corresponding variables and linking data to UCLA datasets. The project used address information provided by TJI to crosswalk facility information to deaths. The crosswalk containing which facilities were joined to address spellings is currently saved in this documentation folder as `tdcj_tji_address_crosswalk.csv.` Data was last pulled from TJI in July 2022 and data files we clipped to only contain deaths for full years (i.e. up to 2021).
