...
Some processing of the files takes place, including the selection of CDCR observations and corresponding variables. 
...
# Show variables present in CA demographic data
colnames(ca.demographics)
