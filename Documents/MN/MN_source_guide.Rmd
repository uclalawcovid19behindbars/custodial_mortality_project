...
mn.deaths <- read_ucla_deaths(agencies = 'MN')
...
# Plot MN decedent data (wrangled to monthly numbers)
ggplot() +
    geom_line(data = mn.deaths %>% group_by(Year, Month) %>% summarise(Total.Deaths = n()) %>% 
