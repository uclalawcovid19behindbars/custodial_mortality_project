...
sd.deaths <- read_ucla_deaths(agencies = 'SD')
...
# Plot SD decedent data (wrangled to monthly numbers)
ggplot() +
    geom_line(data = sd.deaths %>% group_by(Year, Month) %>% summarise(Total.Deaths = n()) %>% 
