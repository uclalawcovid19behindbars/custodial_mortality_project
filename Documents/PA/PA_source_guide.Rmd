...
pa.deaths <- harmonize_ucla_deaths(agencies = 'PA')
...
ggplot() +
    geom_line(data = pa.deaths %>% group_by(Year, Month) %>% summarise(Total.Deaths = n()) %>% 
...
pa.demographics <- harmonize_ucla_dem(agencies = 'PA')
