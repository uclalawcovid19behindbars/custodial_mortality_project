...
id.deaths <- harmonize_ucla_deaths(agencies = 'ID')
...
ggplot() +
    geom_line(data = id.deaths %>% group_by(Year, Month) %>% summarise(Total.Deaths = n()) %>% 
...
id.demographics <- harmonize_ucla_dem(agencies = 'ID')
